...
const btn = document.querySelector("section.claim form button");

btn.addEventListenet('click',() => {
    if (nama !== "" && email !== "") {
        ...
        return (location.href = `https://api.whatsapp.com/send?phone=+6288802791094&text=${encodeURI(text)}`);
    }
});
